                    ...
                    el("button", msg("SAVE_INFO_BUTTON"), {
                        click: async () => {
                            const extra = {
                                ...
                                linktreeInput: this.linktreeInput.domElement.value,
                                homepageInput: this.homepageInput.domElement.value,
                                discordInput: this.discordInput.domElement.value,
                                telegramInput: this.telegramInput.domElement.value,
