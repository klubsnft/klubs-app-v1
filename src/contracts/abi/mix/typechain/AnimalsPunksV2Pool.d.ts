...
interface AnimalsPunksV2PoolInterface extends ethers.utils.Interface {
  functions: {
...
export class AnimalsPunksV2Pool extends BaseContract {
  ...
  interface: AnimalsPunksV2PoolInterface;
