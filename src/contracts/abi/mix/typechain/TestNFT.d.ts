...
interface TestNFTInterface extends ethers.utils.Interface {
  functions: {
...
export class TestNFT extends BaseContract {
  ...
  callStatic: {
    ...
    massMint(amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
