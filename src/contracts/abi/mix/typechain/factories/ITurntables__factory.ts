...
export class ITurntables__factory {
  static readonly abi = _abi;
  static createInterface(): ITurntablesInterface {
    return new utils.Interface(_abi) as ITurntablesInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ITurntables {
    return new Contract(address, _abi, signerOrProvider) as ITurntables;
  }
}
