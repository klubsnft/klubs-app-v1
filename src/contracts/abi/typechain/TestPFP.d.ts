...
interface TestPFPInterface extends ethers.utils.Interface {
  functions: {
    ...
    "massMint(address,uint256)": FunctionFragment;
    ...
    "massMint2(address,uint256,uint256)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "massMint2", data: BytesLike): Result;
...
export class TestPFP extends Contract {
  ...
  functions: {
    ...
    "massMint2(address,uint256,uint256)"(
      to: string,
      fromId: BigNumberish,
      amount: BigNumberish,
      overrides?: Overrides
