...
interface IMetaversesInterface extends ethers.utils.Interface {
  functions: {
...
export class IMetaverses extends Contract {
  ...
  interface: IMetaversesInterface;
  ...
  functions: {
    ...
    extras(id: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
    ...
    banned(id: BigNumberish, overrides?: CallOverrides): Promise<[boolean]>;
  ...
  mileageMode(id: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
  ...
  estimateGas: {
    ...
    extras(id: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    banned(id: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
