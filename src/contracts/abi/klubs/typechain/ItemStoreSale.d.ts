...
interface ItemStoreSaleInterface extends ethers.utils.Interface {
  functions: {
    "cancelSaleByOwner(bytes32[])": FunctionFragment;
    "cancelOfferByOwner(bytes32[])": FunctionFragment;
...
export class ItemStoreSale extends Contract {
  ...
  interface: ItemStoreSaleInterface;
  ...
  functions: {
    ...
    "cancelSaleByOwner(bytes32[])"(
      saleVerificationIDs: BytesLike[],
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    cancelOfferByOwner(
      offerVerificationIDs: BytesLike[],
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    "cancelOfferByOwner(bytes32[])"(
      offerVerificationIDs: BytesLike[],
      overrides?: Overrides
    ): Promise<ContractTransaction>;
