...
const IKLAYSwap_json_1 = __importDefault(require("./abi/mix/artifacts/contracts/Klayswap/interfaces/IKLAYSwap.sol/IKLAYSwap.json"));
...
class KlayswapContract extends Contract_1.default {
    constructor() {
        super(Config_1.default.contracts.Klayswap, IKLAYSwap_json_1.default.abi);
    }
    async buyMix(amount) {
