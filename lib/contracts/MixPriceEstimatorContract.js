...
const MixPriceEstimator_json_1 = __importDefault(require("./abi/mix/artifacts/contracts/MixPriceEstimator.sol/MixPriceEstimator.json"));
const Contract_1 = __importDefault(require("./Contract"));
class MixPriceEstimatorContract extends Contract_1.default {
    constructor() {
        super(Config_1.default.contracts.MixPriceEstimator, MixPriceEstimator_json_1.default.abi);
    }
