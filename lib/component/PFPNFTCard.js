...
class PFPNFTCard extends skynode_1.DomNode {
    ...
    showRarity(rarity) {
        ...
        this.rarityDisplay = (0, skynode_1.el)(".rarity", rarity.scores[this.id] === undefined ? "아직 계산되지 않았습니다." : CommonUtil_1.default.numberWithCommas(String(rarity.scores[this.id]))).appendTo(this);
    }
    hideRarity() {
