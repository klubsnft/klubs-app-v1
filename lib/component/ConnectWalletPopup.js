...
class ConnectWalletPopup extends skynode_1.Popup {
    constructor(callback) {
        ...
        this.append(this.content = (0, skynode_1.el)(".connect-wallet-popup", (0, skynode_1.el)("h2", (0, msg_js_1.default)("CONNECT_WALLET_BUTTON")), (0, skynode_1.el)("p", (0, msg_js_1.default)("CONNECT_WALLET_DESCRIPTION")), (0, skynode_1.el)(".button-container", (0, skynode_1.el)("button.connect-kaikas-button", (0, skynode_1.el)("img", { src: "/images/icon/kaikas.svg" }), (0, msg_js_1.default)("INSTALL_KAIKAS_BUTTON"), { href: "https://chrome.google.com/webstore/detail/kaikas/jblndlipeogpafnldhgmapagcccfchpi", target: "_blank" }), (0, skynode_1.el)("button.connect-klip-button", (0, skynode_1.el)("img", { src: "/images/icon/klip.svg" }), (0, msg_js_1.default)("CONNECT_KLIPS_BUTTON"), {
            click: async () => {
                await Klip_1.default.connect();
                callback();
                this.delete();
            },
        }), (0, skynode_1.el)("button.button.cancel-button", (0, msg_js_1.default)("NOT_CONNECT_AROUND_BUTTON"), {
            click: () => this.delete(),
        }))));
    }
}
