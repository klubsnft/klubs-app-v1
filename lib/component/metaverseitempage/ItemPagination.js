...
class ItemPagination extends skynode_1.DomNode {
        ...
        this.append(this.firstButton = (0, skynode_1.el)("a.first-button", (0, skynode_1.el)("i.fas.fa-backward"), {
            click: () => {
                if (this.page > 1) {
                    ...
                    new Alert_1.default((0, msg_js_1.default)("ANNOUNCEMENT_TITLE"), (0, msg_js_1.default)("FIRST_PAGE_DESCRIPTION"));
                }
            },
            ...
            click: () => {
                if (this.page < this.lastPage) {
                    ...
                    new Alert_1.default((0, msg_js_1.default)("ANNOUNCEMENT_TITLE"), (0, msg_js_1.default)("LAST_PAGE_DESCRIPTION"));
                }
            },
...
//# sourceMappingURL=ItemPagination.js.map