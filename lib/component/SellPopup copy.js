...
class SellPopup extends skynode_1.Popup {
    ...
    async load() {
        for (const [index, addr] of this.addr.entries()) {
            ...
            }), (0, skynode_1.el)(".info", (0, skynode_1.el)(".name", result.body.name), (0, skynode_1.el)("label", (0, skynode_1.el)("span", "판매 가격"), input = (0, skynode_1.el)("input", { placeholder: "판매 가격 (MIX)" })))));
...
//# sourceMappingURL=SellPopup%20copy.js.map