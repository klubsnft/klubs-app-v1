...
class MenuTreeBuilder {
    build(menus, parent) {
        const lis = parent === undefined ? [] : [(0, skynode_1.el)("li.parent", (0, skynode_1.el)(`a${location.pathname === `/${parent.uri}` ? ".on" : ""}`, (0, msg_js_1.default)(parent.key), {
        ...
        for (const menuItem of menus) {
            const li = (0, skynode_1.el)("li", (0, skynode_1.el)(`a${location.pathname === `/${menuItem.uri}` ? ".on" : ""}`, (0, msg_js_1.default)(menuItem.key), {
