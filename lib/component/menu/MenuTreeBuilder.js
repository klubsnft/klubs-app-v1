...
class MenuTreeBuilder {
    build(menus, parent) {
        const lis = parent === undefined ? [] : [(0, skynode_1.el)("li.parent", (0, skynode_1.el)(`a${location.pathname === `/${parent.uri}` ? ".on" : ""}`, parent.name, {
        ...
        for (const menuItem of menus) {
            const li = (0, skynode_1.el)("li", (0, skynode_1.el)(`a${location.pathname === `/${menuItem.uri}` ? ".on" : ""}`, menuItem.name, {
