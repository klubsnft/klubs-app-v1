...
class UserInfo extends skynode_1.DomNode {
    ...
    async loadAddress() {
        ...
        if (address !== undefined) {
            ...
            (this.mobile === true ? this : this.addressDisplay).append((0, skynode_1.el)("ul", (0, skynode_1.el)("li", (0, skynode_1.el)("a", (0, msg_js_1.default)("MY_PFP"), {
                click: () => ViewUtil_1.default.go("/user/my-pfps"),
            })), (0, skynode_1.el)("li", (0, skynode_1.el)("a", (0, msg_js_1.default)("MY_ARTS"), {
                click: () => ViewUtil_1.default.go("/user/my-arts"),
            })), Klip_1.default.connected !== true ? undefined : (0, skynode_1.el)("li", (0, skynode_1.el)("a", (0, msg_js_1.default)("LOGOUT"), {
