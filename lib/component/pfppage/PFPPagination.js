        ...
        this.append(this.firstButton = (0, skynode_1.el)("a.first-button", (0, skynode_1.el)("i.fas.fa-backward"), {
            click: () => {
                if (this.page > 1) {
                    ...
                    new Alert_1.default((0, msg_js_1.default)("ANNOUNCEMENT"), (0, msg_js_1.default)("FIRST_PAGE"));
                }
            },
            ...
            click: () => {
                if (this.page < this.lastPage) {
                    ...
                    new Alert_1.default((0, msg_js_1.default)("ANNOUNCEMENT"), (0, msg_js_1.default)("LAST_PAGE"));
                }
            },
