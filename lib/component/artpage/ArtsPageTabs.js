...
class ArtsPageTabs extends skynode_1.DomNode {
    constructor(type) {
        ...
        this.append((0, skynode_1.el)(`a.tab${type === "all" ? ".on" : ""}`, (0, msg_js_1.default)("ALL"), {
            click: () => ViewUtil_1.default.go(`/arts`),
        }), this.mineTab = (0, skynode_1.el)(`a.tab${type === "mine" ? ".on" : ""}`, (0, msg_js_1.default)("MY_NFT"), {
            click: () => ViewUtil_1.default.go(`/arts/mine`),
        }), this.saleTab = (0, skynode_1.el)(`a.tab${type === "selling" ? ".on" : ""}`, (0, msg_js_1.default)("SELLING"), {
            click: () => ViewUtil_1.default.go(`/arts/selling`),
        }), this.auctionTab = (0, skynode_1.el)(`a.tab${type === "auctions" ? ".on" : ""}`, (0, msg_js_1.default)("BIDDING"), {
    ...
    async load() {
        ...
        if (address !== undefined) {
            ...
            this.mineTab.empty().appendText(`${(0, msg_js_1.default)("MY_NFT")} (${balance})`);
        }
        const onSalesCount = (await ArtStoreContract_1.default.onSalesCount()).toNumber();
        this.saleTab.empty().appendText(`${(0, msg_js_1.default)("SELLING")} (${onSalesCount})`);
        const onAuctionsCount = (await ArtStoreContract_1.default.onAuctionsCount()).toNumber();
        this.auctionTab.empty().appendText(`${(0, msg_js_1.default)("BIDDING")} (${onAuctionsCount})`);
    }
}
