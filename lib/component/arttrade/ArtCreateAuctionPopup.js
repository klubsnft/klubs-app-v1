...
class ArtCreateAuctionPopup extends skynode_1.Popup {
    constructor(id) {
        ...
        this.id = id;
        this.append(this.content = (0, skynode_1.el)(".popup.art-create-auction-popup", (0, skynode_1.el)("h2", (0, msg_js_1.default)("START_AUCTION")), (0, skynode_1.el)("p", (0, msg_js_1.default)("CREATE_AUCTION_POPUP_DESC1")), this.loading = new Loading_1.default(), this.info = (0, skynode_1.el)(".info"), (0, skynode_1.el)(".button-container", (0, skynode_1.el)("button", (0, msg_js_1.default)("START_AUCTION"), {
            click: async () => {
    ...
    async load() {
        ...
        this.info.append((0, skynode_1.el)(".name", data.name), img === undefined ? undefined : new NFTDisplay_1.default(img), (0, skynode_1.el)("label", (0, skynode_1.el)("span", `${(0, msg_js_1.default)("CREATE_AUCTION_POPUP_DESC2")} ${royalty.toNumber() / 100}${(0, msg_js_1.default)("CREATE_AUCTION_POPUP_DESC3")} ${Config_1.default.fee}${(0, msg_js_1.default)("CREATE_AUCTION_POPUP_DESC4")}`), this.startPriceInput = (0, skynode_1.el)("input", { placeholder: (0, msg_js_1.default)("AUCTION_START_PRICE") })), (0, skynode_1.el)("label", (0, skynode_1.el)("span", `${(0, msg_js_1.default)("CREATE_AUCTION_POPUP_DESC5")} ${currentBlock})`), (0, skynode_1.el)("p.warning", (0, skynode_1.el)("i.fas.fa-exclamation-triangle"), (0, msg_js_1.default)("CREATE_AUCTION_POPUP_DESC6")), this.endBlockInput = (0, skynode_1.el)("input", { placeholder: (0, msg_js_1.default)("END_AUCTION_BLOCK") })));
        this.loading.delete();
    }
}
