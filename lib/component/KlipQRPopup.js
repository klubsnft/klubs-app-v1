...
class KlipQRPopup extends skynode_1.Popup {
    constructor(dataURL) {
        ...
        this.append(this.content = (0, skynode_1.el)(".klip-qr-popup", (0, skynode_1.el)("h2", (0, msg_js_1.default)("CONNECT_QR_KLIP_TITLE")), (0, skynode_1.el)(".qr", (0, skynode_1.el)("img", { src: dataURL })), (0, skynode_1.el)("p", (0, msg_js_1.default)("CONNECT_QR_KLIP_DESCRIPTION_1")), (0, skynode_1.el)("p", (0, msg_js_1.default)("CONNECT_QR_KLIP_DESCRIPTION_2")), (0, skynode_1.el)("p", (0, msg_js_1.default)("CONNECT_QR_KLIP_DESCRIPTION_3")), (0, skynode_1.el)(".button-container", (0, skynode_1.el)("button", (0, msg_js_1.default)("CONFIRM_BUTTON"), {
            click: () => this.delete(),
        }))));
    }
}
