...
class OfferPopup extends skynode_1.Popup {
    ...
    async load() {
        ...
        this.list.append((0, skynode_1.el)("section", img === undefined ? undefined : (0, skynode_1.el)("img", { src: ProxyUtil_1.default.imageSRC(img) }), (0, skynode_1.el)(".info", (0, skynode_1.el)(".name", data.name), (0, skynode_1.el)("label", (0, skynode_1.el)("span", "제안 가격"), input = (0, skynode_1.el)("input", { placeholder: "제안 가격 (MIX)" })))));
