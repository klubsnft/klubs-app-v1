...
class OfferPopup extends skynode_1.Popup {
    constructor(addr, id) {
        ...
        this.id = id;
        this.inputs = [];
        this.append(this.content = (0, skynode_1.el)(".popup.pfp-offer-popup", (0, skynode_1.el)("h2", (0, msg_js_1.default)("OFFER_PRICE")), (0, skynode_1.el)("p", (0, msg_js_1.default)("OFFER_POPUP_DESC1")), this.loading = new Loading_1.default(), this.list = (0, skynode_1.el)(".list"), (0, skynode_1.el)(".button-container", (0, skynode_1.el)("button", (0, msg_js_1.default)("OFFER_IT"), {
            click: async () => {
                const prices = [];
    ...
    async load() {
        ...
        this.list.append((0, skynode_1.el)("section", img === undefined ? undefined : new NFTDisplay_1.default(img), (0, skynode_1.el)(".info", (0, skynode_1.el)(".name", data.name), (0, skynode_1.el)("label", (0, skynode_1.el)("span", (0, msg_js_1.default)("PRICE_OFFER")), input = (0, skynode_1.el)("input", { placeholder: (0, msg_js_1.default)("PRICE_OFFER_MIX") })))));
