...
class BidPopup extends skynode_1.Popup {
    constructor(addr, id) {
        ...
        this.id = id;
        this.inputs = [];
        this.append(this.content = (0, skynode_1.el)(".popup.pfp-bid-popup", (0, skynode_1.el)("h2", (0, msg_js_1.default)("BID_IT")), (0, skynode_1.el)("p", (0, msg_js_1.default)("BID_POPUP_DESC1")), this.loading = new Loading_1.default(), this.list = (0, skynode_1.el)(".list"), (0, skynode_1.el)(".button-container", (0, skynode_1.el)("button", (0, msg_js_1.default)("BID_IT"), {
            click: async () => {
