...
class Detail {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".pfp-detail-view", (0, skynode_1.el)(".image-view", (0, skynode_1.el)("img.pfp-image", { src: "/images/galaxies.png" }), (0, skynode_1.el)("button.button-contained", "구매하기"), (0, skynode_1.el)(".label", "제안 가격"), (0, skynode_1.el)("input", {
            placeholder: '... MIX'
        }), (0, skynode_1.el)("button.button-contained", "제안하기")), (0, skynode_1.el)(".over-view", (0, skynode_1.el)("a.project", "Doge Sound Clubs"), (0, skynode_1.el)(".pfp", "Robot Hoodie #9748"), (0, skynode_1.el)(".pfp-info", (0, skynode_1.el)(".owner", "소유자는", (0, skynode_1.el)(".owner-by", "dilrong")), (0, skynode_1.el)(".viewer", (0, skynode_1.el)("img.viewer-icon", { src: "/images/icon/visibility.png", hegiht: 24 }), "1", " 명 감상")), (0, skynode_1.el)(".description", (0, skynode_1.el)(".title", "설명"), (0, skynode_1.el)("hr.divider"), (0, skynode_1.el)("span.body", `DSC MATES가 무엇인가요?
...
//# sourceMappingURL=Detail%20copy.js.map