    ...
    async loadNFTs() {
        ...
        if (this.filter.idQuery !== undefined) {
            ...
            for (let i = start; i < limit; i += 1) {
                new PFPNFTCard_1.default(this.addr, ids[i]).appendTo(this.nftList);
            }
        }
