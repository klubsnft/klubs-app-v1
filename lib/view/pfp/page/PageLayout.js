...
class PageLayout {
    constructor(params) {
        ...
        Layout_1.default.current.title = (0, msg_js_1.default)("PFP_DETAIL_INFO");
    ...
    async loadInfo(addr) {
        ...
        try {
            ...
            if (data.mineable === true) {
                this.miningInfoDisplay.empty().append((0, skynode_1.el)("a.mining", (0, skynode_1.el)("img", { src: "/images/icon/mining.png", height: "14" }), (0, skynode_1.el)("span", (0, msg_js_1.default)("IS_MINING")), {
                    title: (0, msg_js_1.default)("IS_MINING_DESC2"),
    ...
    async loadUpdateButton(addr) {
        try {
            ...
            if (address !== undefined && await PFPsContract_1.default.existsManager(addr, address) === true) {
                (0, skynode_1.el)("button.update-button", (0, msg_js_1.default)("UPDATE_PFP_INFO"), {
