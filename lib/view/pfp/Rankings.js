...
class Rankings {
    constructor() {
        Layout_1.default.current.title = (0, msg_js_1.default)("PFP_RANKING_TITLE");
        Layout_1.default.current.content.append((this.container = (0, skynode_1.el)(".pfp-ranking-view", (0, skynode_1.el)("header", (0, skynode_1.el)("h1", (0, msg_js_1.default)("PFP_RANKING_TITLE")), (0, skynode_1.el)("span", (0, msg_js_1.default)("PFP_RANKIN_DESCRIPTION"))), (0, skynode_1.el)("table", (0, skynode_1.el)("thead", (0, skynode_1.el)("tr", (0, skynode_1.el)("td", "PFP", { colspan: "3" }), (0, skynode_1.el)("td", (0, msg_js_1.default)("RANKING_TOTAL_TRADING_VOLUME")), (0, skynode_1.el)("td.mobile", (0, msg_js_1.default)("RANKING_30DAYS_TRADING_VOLUME")), (0, skynode_1.el)("td.mobile", (0, msg_js_1.default)("RANKING_7DAYS_TRADING_VOLUME")), (0, skynode_1.el)("td.mobile", (0, msg_js_1.default)("RANKING_24HOURS_TRADING_VOLUME")))), this.list = (0, skynode_1.el)("tbody")), this.loading = new Loading_1.default())));
        this.load();
    }
    async load() {
