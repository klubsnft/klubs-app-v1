            ...
            if (await PFPsContract_1.default.banned(info.id) !== true) {
                ...
                if (extras.trim() !== "") {
                    ...
                    if (this.container.deleted !== true) {
                        ...
                        this.list.append((0, skynode_1.el)("tr", (0, skynode_1.el)("td", String(index + 1)), (0, skynode_1.el)("td", (0, skynode_1.el)("img", { src, height: "40" })), (0, skynode_1.el)("td", (0, skynode_1.el)("a", data.name, { click: () => ViewUtil_1.default.go(`/pfp/${info.id}`) })), (0, skynode_1.el)("td", CommonUtil_1.default.numberWithCommas(String(info.total)), " MIX"), (0, skynode_1.el)("td", CommonUtil_1.default.numberWithCommas(String(info.volume30d)), " MIX"), (0, skynode_1.el)("td", CommonUtil_1.default.numberWithCommas(String(info.volume7d)), " MIX"), (0, skynode_1.el)("td", CommonUtil_1.default.numberWithCommas(String(info.volume24h)), " MIX")));
                    }
                }
            }
        }
