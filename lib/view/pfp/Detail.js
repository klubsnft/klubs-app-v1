...
class Detail {
    constructor(params) {
        ...
        })), (0, skynode_1.el)(".list-container", this.nftLoading = (0, skynode_1.el)(".loading", "Loading..."), this.nftList = (0, skynode_1.el)(".list"), (0, skynode_1.el)(".pagination", this.prevButton = (0, skynode_1.el)("a.prev", (0, skynode_1.el)("i.fas.fa-arrow-left"), {
            click: () => {
                if (this.page > 0) {
                    this.page -= 1;
                    this.loadNFTs(addr);
