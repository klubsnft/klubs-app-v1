...
class Detail {
    constructor(params) {
        ...
        })), (0, skynode_1.el)("main", (0, skynode_1.el)("header", (0, skynode_1.el)("h2", "NFT 목록"), (0, skynode_1.el)(".tab-container", (0, skynode_1.el)("a.tab", "판매중"), (0, skynode_1.el)("a.tab", "전체"))), (0, skynode_1.el)(".content", (0, skynode_1.el)(".search-box", this.idQueryInput = (0, skynode_1.el)("input", {
            placeholder: "ID로 검색",
            change: () => {
