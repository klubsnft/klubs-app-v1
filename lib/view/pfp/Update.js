    ...
    async loadManagers(addr) {
        ...
        for (let i = 0; i < managerCount.toNumber(); i += 1) {
            const promise = async (index) => {
                ...
                this.managerList.append((0, skynode_1.el)("li", (0, skynode_1.el)("span.item", manager), (0, skynode_1.el)("button.button-text", (0, skynode_1.el)("img", { src: '/images/icon/delete' }), {
                    click: async () => {
