...
class Update {
    constructor(params) {
        ...
        })), this.miningInfoURLLabel = (0, skynode_1.el)("label", (0, skynode_1.el)("h3", "채굴 정보 URL"), (0, skynode_1.el)("p", "채굴 정보를 확인할 수 있는 페이지의 URL을 기입합니다."), this.miningInfoURLInput = (0, skynode_1.el)("input", { type: "url", placeholder: "채굴 정보 URL" })), (0, skynode_1.el)("button", "정보 저장", {
            click: async () => {
                const extra = {
