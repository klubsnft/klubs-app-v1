...
class Update {
    constructor(params) {
        ...
        })), (0, skynode_1.el)("label", (0, skynode_1.el)("h4", "아이콘 이미지 주소"), this.iconPreview = (0, skynode_1.el)("img.icon-preview"), this.iconInput = (0, skynode_1.el)("input", {
            type: "url",
            placeholder: "아이콘 이미지 주소",
            change: () => {
                this.iconPreview.domElement.src = this.iconInput.domElement.value;
            },
        })), (0, skynode_1.el)("label", (0, skynode_1.el)("h4", "아이콘 업로드"), (0, skynode_1.el)("input", {
            type: "file",
            change: (event) => {
                const file = event.target.files[0];
                const reader = new FileReader();
