...
class NFTDetail {
    constructor(params) {
        ...
        }), this.nameDisplay = (0, skynode_1.el)(".name"), this.ownerDisplay = (0, skynode_1.el)(".owner"), this.descriptionDisplay = (0, skynode_1.el)(".description"), (0, skynode_1.el)("a.refresh-button", "정보 새로고침", {
            click: async () => {
