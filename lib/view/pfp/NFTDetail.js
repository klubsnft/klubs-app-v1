    ...
    async loadInfo(addr, id) {
        try {
            ...
            if (data.animation_url !== undefined) {
                this.nftDisplayContainer.append(new NFTDisplay_1.default(data.animation_url, undefined, true));
            }
                ...
                try {
                    ...
                    if (offerInfo.price.gt(0)) {
                        ...
                        if (offerInfo.offeror === walletAddress) {
                            offer.append((0, skynode_1.el)("a.cancel-offer-button", (0, msg_js_1.default)("CANCEL_OFFER_BUTTON"), {
                                click: async () => {
