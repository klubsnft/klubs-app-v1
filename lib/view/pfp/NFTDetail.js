...
class NFTDetail {
    constructor(params) {
        ...
        Layout_1.default.current.title = (0, msg_js_1.default)("NFT_DETAIL");
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".pfp-nft-detail-view", this.nftDisplayContainer = (0, skynode_1.el)(".nft-display-container"), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", (0, msg_js_1.default)("BASE_INFO")), (0, skynode_1.el)(".info", this.pfpDisplay = (0, skynode_1.el)("a.pfp", {
            click: () => ViewUtil_1.default.go(`/pfp/${addr}`),
        }), this.nameDisplay = (0, skynode_1.el)(".name"), this.ownerDisplay = (0, skynode_1.el)(".owner"), this.descriptionDisplay = (0, skynode_1.el)(".description"), this.sendButtonContainer = (0, skynode_1.el)(".send-button-container"), (0, skynode_1.el)("a.refresh-button", (0, msg_js_1.default)("REFRESH"), {
            click: async () => {
                await Loader_1.default.cacheMetadata(addr, id);
                skyrouter_1.SkyRouter.refresh();
            },
        }))), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", (0, msg_js_1.default)("PROPERTY")), this.attributesDisplay = (0, skynode_1.el)(".attributes")), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", (0, msg_js_1.default)("DEAL")), this.tradeForm = (0, skynode_1.el)(".trade-form")), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", (0, msg_js_1.default)("OFFER_PRICE")), this.offerForm = (0, skynode_1.el)(".offer-form")), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", (0, msg_js_1.default)("ACTION")), this.auctionForm = (0, skynode_1.el)(".auction-form")), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", (0, msg_js_1.default)("TRANSACTION_HISTORY")), this.activity = (0, skynode_1.el)(".activity"))));
        this.loadPFP(addr);
    ...
    async loadTrade(addr, id) {
        ...
        if (owner === PFPStoreContract_1.default.address) {
            ...
            this.ownerDisplay.empty().appendText((0, msg_js_1.default)("OWNER"));
        ...
        if (owner === address) {
            this.sendButtonContainer.empty().append((0, skynode_1.el)("a", (0, msg_js_1.default)("TRANSFER"), {
                click: () => new Prompt_1.default((0, msg_js_1.default)("TRANSFER"), (0, msg_js_1.default)("TRANSFER_DESC1"), (0, msg_js_1.default)("TRANSFER"), async (to) => {
    ...
    async loadSale(walletAddress, owner, addr, id) {
        ...
        if (saleInfo.price.gt(0)) {
            ...
            priceDispay.appendText((0, msg_js_1.default)("NOT_SELLING"));
        }
        if (walletAddress === owner) {
            this.tradeForm.append((0, skynode_1.el)("a.sell-button", (0, msg_js_1.default)("SELL_IT"), {
                click: () => new SellPopup_1.default([addr], [id]),
            }));
        }
        else if (saleInfo.seller === walletAddress) {
            this.tradeForm.append((0, skynode_1.el)("a.cancel-sell-button", (0, msg_js_1.default)("CANCEL_CELL"), {
                click: async () => {
            ...
            this.tradeForm.append((0, skynode_1.el)("a.buy-button", (0, msg_js_1.default)("BUY_IT"), {
    ...
    async loadOffers(walletAddress, owner, addr, id) {
                ...
                try {
                    ...
                    if (offerInfo.price.gt(0)) {
                        ...
                        if (offerInfo.offeror === walletAddress) {
                            ...
                            offer.append((0, skynode_1.el)("a.accept-offer-button", (0, msg_js_1.default)("ACCEPT_OFFER"), {
                                click: () => new AcceptOfferPopup_1.default(addr, id, offerId),
                            }));
                        }
                        if (walletAddress === Config_1.default.adminAddress) {
                            offer.append((0, skynode_1.el)("a.cancel-offer-button", (0, msg_js_1.default)("FORCE_CANCEL_OFFER"), {
                                click: async () => {
        ...
        if (walletAddress !== owner && saleInfo.seller !== walletAddress) {
            this.offerForm.append((0, skynode_1.el)("a.offer-button", (0, msg_js_1.default)("OFFER_PRICE"), {
    ...
    async loadAuction(walletAddress, owner, addr, id) {
        ...
        if (auctionStarted === true) {
            ...
            const refresh = async () => {
                ...
                p.empty();
                if (diff < 0) {
                    p.appendText((0, msg_js_1.default)("ENDED_AUCTION"));
                }
                else {
                    p.appendText(`${(0, msg_js_1.default)("ENDED_AUCTION_DESC1")} ${diff} ${(0, msg_js_1.default)("ENDED_AUCTION_DESC2")} (${CommonUtil_1.default.displayBlockDuration(diff)})`);
                }
            };
            await refresh();
            ...
            if (diff < 0) {
                if (biddingCount === 0) {
                    if (walletAddress === auction.seller) {
                        this.auctionForm.append((0, skynode_1.el)("a.claim-button", (0, msg_js_1.default)("END_AUCTION"), {
                            click: async () => {
                ...
                this.auctionForm.append((0, skynode_1.el)("a.bid-button", (0, msg_js_1.default)("BID_IT"), {
            ...
            this.auctionForm.append((0, skynode_1.el)("a.create-auction-button", (0, msg_js_1.default)("START_AUCTION"), {
    ...
    async loadActivity(walletAddress, owner, addr, id) {
        ...
        for (const trade of result.body) {
            let eventName;
            if (trade.event === "Sell") {
                eventName = (0, msg_js_1.default)("SELL");
            }
            else if (trade.event === "Buy") {
                eventName = (0, msg_js_1.default)("BUY");
            }
            else if (trade.event === "CancelSale") {
                eventName = (0, msg_js_1.default)("CANCEL_CELL");
            }
            else if (trade.event === "MakeOffer") {
                eventName = (0, msg_js_1.default)("OFFER");
            }
            else if (trade.event === "CancelOffer") {
                eventName = (0, msg_js_1.default)("CANCEL_OFFER");
            }
            else if (trade.event === "AcceptOffer") {
                eventName = (0, msg_js_1.default)("ACCEPT_OFFER");
            }
            else if (trade.event === "CreateAuction") {
                eventName = (0, msg_js_1.default)("START_AUCTION");
            }
            else if (trade.event === "CancelAuction") {
                eventName = (0, msg_js_1.default)("CANCEL_AUCTION");
            }
            else if (trade.event === "Bid") {
                eventName = (0, msg_js_1.default)("ACTION");
            }
            else if (trade.event === "Claim") {
                eventName = (0, msg_js_1.default)("END_AUCTION");
            }
