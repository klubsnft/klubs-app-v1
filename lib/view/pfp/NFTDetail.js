...
class NFTDetail {
    constructor(params) {
        ...
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".pfp-nft-detail-view", this.nftDisplayContainer = (0, skynode_1.el)(".nft-display-container"), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", "기본 정보"), this.pfpDisplay = (0, skynode_1.el)("a.pfp", {
