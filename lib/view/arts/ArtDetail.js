...
class ArtDetail {
    ...
    async loadArtist(id) {
        ...
        this.artistDisplay.empty().appendText((0, msg_js_1.default)("ARTIST"));
    ...
    async loadTrade(id) {
        if (await ArtsContract_1.default.exists(id) === true) {
            ...
            const artist = await ArtsContract_1.default.artToArtist(id);
            if (artist === address) {
                this.updateButtonContainer.empty().append((0, skynode_1.el)("a", (0, msg_js_1.default)("REVISION_IT"), {
    ...
    async loadActivity(walletAddress, owner, id) {
        ...
        for (const trade of result.body) {
            ...
            if (trade.event === "Sell") {
                ...
                eventName = (0, msg_js_1.default)("CHANGE_SELL_PRICE");
            }
