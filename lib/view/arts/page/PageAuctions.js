...
class PageAuctions {
    constructor() {
        PageLayout_1.default.current.content.append(this.container = (0, skynode_1.el)(".arts-page-view.arts-page-auctions-view"));
        this.load();
    }
    async load() {
        this.container.append((0, skynode_1.el)("header", (0, skynode_1.el)("h2", (0, msg_js_1.default)("NFT_LIST_TITLE")), new ArtsPageTabs_1.default("auctions")), (0, skynode_1.el)(".content", (0, skynode_1.el)(".list-container", this.nftLoading = new Loading_1.default(), this.nftList = (0, skynode_1.el)(".list"))));
        this.loadNFTs();
    }
    async loadNFTs() {
        ...
        this.nftList.empty();
        const ids = [];
        const totalSupply = (await ArtStoreContract_1.default.onAuctionsCount()).toNumber();
        const promises = [];
        for (let i = 0; i < totalSupply; i += 1) {
            const promise = async (index) => {
                try {
                    const id = (await ArtStoreContract_1.default.onAuctions(index)).toNumber();
                    ids.push(id);
                }
                catch (e) {
                    console.error(e);
