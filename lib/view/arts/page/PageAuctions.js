...
class PageAuctions {
    ...
    async load() {
        this.container.append((0, skynode_1.el)("header", (0, skynode_1.el)("h2", (0, msg_js_1.default)("NFT_LIST")), new ArtsPageTabs_1.default("auctions")), (0, skynode_1.el)(".content", (0, skynode_1.el)(".list-container", this.nftLoading = new Loading_1.default(), this.nftList = (0, skynode_1.el)(".list"))));
        this.loadNFTs();
    }
    async loadNFTs() {
