...
class PageLayout {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".arts-page-layout", (0, skynode_1.el)("header", (0, skynode_1.el)("p", (0, msg_js_1.default)("ARTS_DESC1")), this.controller = (0, skynode_1.el)(".controller")), this.content = (0, skynode_1.el)("main")));
        this.load();
    ...
    async load() {
        ...
        if (address !== undefined) {
            ...
            if (added === true) {
                this.controller.empty().append((0, skynode_1.el)("a", (0, msg_js_1.default)("REVISION_ARTIST"), {
                    click: () => ViewUtil_1.default.go("/arts/artists/update"),
                }), (0, skynode_1.el)("a", (0, msg_js_1.default)("ADD_ART"), {
                    click: async () => {
                        new Confirm_1.default((0, msg_js_1.default)("ADD_ART"), (0, msg_js_1.default)("ADD_ART_CONFIRM"), (0, msg_js_1.default)("CREATE_IT"), async () => {
                ...
                this.controller.empty().append((0, skynode_1.el)("a", (0, msg_js_1.default)("ADD_CREATOR"), {
