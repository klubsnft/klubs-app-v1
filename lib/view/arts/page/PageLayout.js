...
class PageLayout {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".arts-page-layout", (0, skynode_1.el)("header", (0, skynode_1.el)("p"), this.controller = (0, skynode_1.el)(".controller")), this.content = (0, skynode_1.el)("main")));
        this.load();
