...
class Home {
    constructor() {
        ...
        Layout_1.default.current.content.append((this.container = (0, skynode_1.el)(".home-view", (0, skynode_1.el)("header", (0, skynode_1.el)("p", "Klubs는 클레이튼 기반 NFT 마켓플레이스입니다. MIX를 사용합니다."), (0, skynode_1.el)("a", "Klubs 소개", {
            ...
            target: "_blank",
        })), (0, skynode_1.el)(".content", (0, skynode_1.el)(".slide", (0, skynode_1.el)("h2", "PFP"), this.pfpLoading = (0, skynode_1.el)(".loading", "Loading..."), (0, skynode_1.el)(".pfp-list-container", this.pfpList = (0, skynode_1.el)(".pfp-list"))), (0, skynode_1.el)(".slide", (0, skynode_1.el)("h2", "Art"), (0, skynode_1.el)("p", "Art는 출시 준비중입니다."))))));
        this.load();
    }
    async load() {
        this.pfpList.empty();
