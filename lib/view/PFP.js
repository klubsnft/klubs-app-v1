...
class PFP {
    constructor() {
        Layout_1.default.current.title = (0, msg_js_1.default)("PFP_PROJECTS");
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".pfp-view", (0, skynode_1.el)("header", (0, skynode_1.el)("p", (0, msg_js_1.default)("PFP_PROJECTS_DESC")), (0, skynode_1.el)("a", (0, msg_js_1.default)("PROJECT_ADD"), {
            click: () => ViewUtil_1.default.go("/pfp/add"),
        })), (0, skynode_1.el)(".content", (0, skynode_1.el)("h2", (0, msg_js_1.default)("PROJECT_LIST")), this.pfpLoading = new Loading_1.default(), this.pfpList = (0, skynode_1.el)(".pfp-list"))));
        this.load();
    }
    async load() {
        this.pfpList.empty();
