...
const PFPCardView_1 = __importDefault(require("../component/PFPCardView"));
    ...
    async load() {
        ...
        for (let i = 0; i < addrCount.toNumber(); i += 1) {
            const promise = async (index) => {
                ...
                new PFPCardView_1.default(addr, data.banner, data.icon, data.name, data.description).appendTo(this.pfpList);
            };
