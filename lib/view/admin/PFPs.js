...
class PFPs {
    constructor() {
        Layout_1.default.current.title = (0, msg_js_1.default)("PFP_INFOS_TITLE");
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".admin-pfps-view", (0, skynode_1.el)("h1", (0, msg_js_1.default)("PFP_INFOS_TITLE"))));
        this.load();
    }
    async load() {
        ...
        for (let index = count.toNumber() - 1; index >= 0; index -= 1) {
            ...
            (0, skynode_1.el)(".pfp", { style: { marginTop: 20 }, }, addr, "\n", JSON.stringify(managers), "\n", extras, "\n", (0, skynode_1.el)("a", (0, msg_js_1.default)("SETTING_EXTRA_BUTTON"), {
                click: () => new Prompt_1.default((0, msg_js_1.default)("SETTING_EXTRA_TITLE"), (0, msg_js_1.default)("INPUT_EXTRA_DESCRIPTION"), (0, msg_js_1.default)("DONE_BUTTON"), async (extra) => {
                    await PFPsContract_1.default.setExtra(addr, extra);
                }),
            }), "\n", royalty.royalty.toString(), "\n", (0, skynode_1.el)("a", (0, msg_js_1.default)("SETTING_ROYALTY_BUTTON"), {
                click: () => new Prompt_1.default((0, msg_js_1.default)("SETTING_ROYALTY_TITLE"), (0, msg_js_1.default)("INPUT_ROYALTY_DESCRIPTION"), (0, msg_js_1.default)("DONE_BUTTON"), async (r) => {
