...
class PFPProposals {
    constructor() {
        Layout_1.default.current.title = (0, msg_js_1.default)("WAITING_PFP_INFOS");
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".admin-pfp-proposals-view", (0, skynode_1.el)("h1", (0, msg_js_1.default)("WAITING_PFP_INFOS"))));
        this.load();
    }
    async load() {
        ...
        for (let id = count.toNumber() - 1; id >= 0; id -= 1) {
            ...
            if (await PFPsContract_1.default.added(proposal.addr) !== true) {
                const proposalDisplay = (0, skynode_1.el)(".proposal", JSON.stringify(proposal), (0, skynode_1.el)("a", (0, msg_js_1.default)("PASS"), {
                    click: async () => {
