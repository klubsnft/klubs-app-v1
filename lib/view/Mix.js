...
class Mix {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".mix-view", (0, skynode_1.el)("h1", (0, msg_js_1.default)("MIX")), (0, skynode_1.el)("img", { src: "/images/mix.png", height: "200" }), (0, skynode_1.el)(".price", (0, skynode_1.el)("span", "1 MIX = "), this.priceDisplay = (0, skynode_1.el)("span"), (0, skynode_1.el)("span", "원")), (0, skynode_1.el)("a.buy-mix-button", (0, msg_js_1.default)("BUYING_MIX"), {
            click: () => new Prompt_1.default((0, msg_js_1.default)("BUY_MIX"), (0, msg_js_1.default)("HOW_TO_BUY_MIX"), (0, msg_js_1.default)("BUY_MIX"), async (amount) => {
                const mix = ethers_1.utils.parseEther(amount);
                await KlayswapContract_1.default.buyMix(mix);
            }),
        }), (0, skynode_1.el)("p", (0, msg_js_1.default)("MIX_DESC1")), (0, skynode_1.el)("a.whitepaper-button", (0, msg_js_1.default)("MIX_WHITEPAPER_BUTTON"), { href: "https://medium.com/dogesoundclub/dsc-mix-nft-%ED%97%88%EB%B8%8C%EB%A5%BC-%EC%9C%84%ED%95%9C-%ED%86%A0%ED%81%B0-3299dd3a8d1d", target: "_blank" })));
        this.loadPrice();
    }
    async loadPrice() {
