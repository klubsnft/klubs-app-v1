...
class MyPFPs {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".user-my-pfps-view", (0, skynode_1.el)("header", (0, skynode_1.el)("h1", "내 PFP 정보")), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", "내가 관리하는 PFP"), this.managingLoading = new Loading_1.default(), (0, skynode_1.el)(".list-container", this.managingList = (0, skynode_1.el)(".list"))), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", "내가 판매중인 PFP"), this.sellingLoading = new Loading_1.default(), (0, skynode_1.el)(".list-container", this.sellingList = (0, skynode_1.el)(".list"))), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", "내가 가격을 제시한 PFP"), this.offeringLoading = new Loading_1.default(), (0, skynode_1.el)(".list-container", this.offeringList = (0, skynode_1.el)(".list"))), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", "내 PFP 목록"), this.myNFTLoading = new Loading_1.default(), (0, skynode_1.el)(".list-container", this.myNFTList = (0, skynode_1.el)(".list")))));
        this.load();
    }
    async load() {
    ...
    async loadSelling(address) {
        ...
        for (let i = 0; i < count; i += 1) {
            const promise = async (index) => {
                ...
                const url = await new KIP17Contract_1.default(info.pfp).tokenURI(info.id);
                const data = await ProxyUtil_1.default.loadURL(url);
                const saleInfo = await PFPStoreContract_1.default.sales(info.pfp, info.id);
                if (this.container.deleted !== true) {
                    new PFPNFTCard_1.default(info.pfp, info.id, data.image, data.name, saleInfo.price).appendTo(this.sellingList);
                }
            };
            promises.push(promise(i));
        }
    ...
    async loadOffering(address) {
        ...
        for (let i = 0; i < count; i += 1) {
            const promise = async (index) => {
                ...
                const saleInfo = await PFPStoreContract_1.default.sales(info.pfp, info.id);
                if (this.container.deleted !== true) {
                    new PFPNFTCard_1.default(info.pfp, info.id, data.image, data.name, saleInfo.price).appendTo(this.offeringList);
                }
            };
            promises.push(promise(i));
        }
            ...
            const promise = async (index) => {
                ...
                if (enumerable === true) {
                    ...
                    for (let j = 0; j < balance; j += 1) {
                        ...
                        if (this.container.deleted !== true) {
                            new PFPNFTCard_1.default(addr, id, data.image, data.name, saleInfo.price).appendTo(this.myNFTList);
                        }
                    }
                }
                else {
                    const result = await superagent_1.default.get(`https://api.klu.bs/pfp/${addr}/owner/${address}`);
