...
class MyPFPs {
    constructor(params) {
        ...
        Layout_1.default.current.title = (0, msg_js_1.default)("MY_PFP_TITLE");
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".user-my-pfps-view", (0, skynode_1.el)("header", (0, skynode_1.el)("h1", (0, msg_js_1.default)("MY_PFP_TITLE"))), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", (0, msg_js_1.default)("MY_MANAGE_PFP_TITLE")), this.managingLoading = new Loading_1.default(), this.managingList = (0, skynode_1.el)(".list")), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", (0, msg_js_1.default)("MY_SELLING_PFP_TITLE")), this.sellingLoading = new Loading_1.default(), this.sellingList = (0, skynode_1.el)(".list")), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", (0, msg_js_1.default)("MY_BIDDING_PFP_TITLE")), this.auctionLoading = new Loading_1.default(), this.auctionList = (0, skynode_1.el)(".list")), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", (0, msg_js_1.default)("MY_OFFER_PFP_TITLE")), this.offeringLoading = new Loading_1.default(), this.offeringList = (0, skynode_1.el)(".list")), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", (0, msg_js_1.default)("MY_PFP_LIST_TITLE")), (0, skynode_1.el)("p.warning", (0, skynode_1.el)("i.fas.fa-exclamation-triangle"), (0, msg_js_1.default)("MY_PFP_LIST_WARNING")), this.myNFTLoading = new Loading_1.default(), this.pagination1 = new PFPPagination_1.default(this, this.page), this.myNFTList = (0, skynode_1.el)(".list"), this.pagination2 = new PFPPagination_1.default(this, this.page))));
        this.load();
    }
    async load() {
    ...
    async loadSelling(address) {
        ...
        for (let i = 0; i < count; i += 1) {
            const promise = async (index) => {
                ...
                const extras = await PFPsContract_1.default.extras(info.pfp);
                let data = {};
                try {
                    data = JSON.parse(extras);
                }
