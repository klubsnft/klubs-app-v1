...
class MyArts {
    constructor() {
        Layout_1.default.current.title = (0, msg_js_1.default)("MY_ARTS");
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".user-my-arts-view", (0, skynode_1.el)("header", (0, skynode_1.el)("h1", (0, msg_js_1.default)("MY_ARTS_INFO"))), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", (0, msg_js_1.default)("MY_ADD_ARTS")), this.artistArtsLoading = new Loading_1.default(), this.artistArtsList = (0, skynode_1.el)(".list")), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", (0, msg_js_1.default)("MY_SELLING_ARTS")), this.sellingLoading = new Loading_1.default(), this.sellingList = (0, skynode_1.el)(".list")), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", (0, msg_js_1.default)("MY_BIDDING_ARTS")), this.auctionLoading = new Loading_1.default(), this.auctionList = (0, skynode_1.el)(".list")), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", (0, msg_js_1.default)("MY_OFFER_ARTS")), this.offeringLoading = new Loading_1.default(), this.offeringList = (0, skynode_1.el)(".list")), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", (0, msg_js_1.default)("MY_ARTS_LIST")), this.myNFTLoading = new Loading_1.default(), this.myNFTList = (0, skynode_1.el)(".list"))));
        this.load();
    }
    async load() {
