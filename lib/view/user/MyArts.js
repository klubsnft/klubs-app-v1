...
class MyArts {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".user-my-arts-view", (0, skynode_1.el)("header", (0, skynode_1.el)("h1", "내 Arts 정보")), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", "내가 등록한 작품들"), this.artistArtsLoading = new Loading_1.default(), this.artistArtsList = (0, skynode_1.el)(".list")), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", "내가 판매중인 Arts"), this.sellingLoading = new Loading_1.default(), this.sellingList = (0, skynode_1.el)(".list")), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", "내가 경매 진행중인 Arts"), this.auctionLoading = new Loading_1.default(), this.auctionList = (0, skynode_1.el)(".list")), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", "내가 가격을 제시한 Arts"), this.offeringLoading = new Loading_1.default(), this.offeringList = (0, skynode_1.el)(".list")), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", "내 Arts 목록"), this.myNFTLoading = new Loading_1.default(), this.myNFTList = (0, skynode_1.el)(".list"))));
        this.load();
    }
    async load() {
